...
class BaseObject:
    ...
    def _get_config(
        ...
        - `predictably_core` global configuration,
    ...
    def _set_config(self, **config_dict: Any) -> Self:
        ...
        the `predictably_core` global configuration for the object.
    ...
    def __repr__(self, n_char_max: int = 700) -> str:
        ...
        """
        from predictably_core.core._pprint._pprint import _BaseObjectPrettyPrinter
